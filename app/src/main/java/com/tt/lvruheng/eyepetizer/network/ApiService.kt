...
interface ApiService {
    ...
    //获取首页第一页数据
    @GET("v2/feed?num=2")
    fun getHomeData(@Query("udid") udid: String, @Query("vc") vc: Int): Observable<HomeBean>
    ...
    //获取发现频道信息
    @GET("v2/categories")
    fun getFindData(@Query("udid") udid: String, @Query("vc") vc: Int): Observable<MutableList<FindBean>>
